...
class HelpCommand extends BaseCommand {
    async process(message) {
        ...
        `
                    ...
                    .setFooter(
                        'This documentation covers the current release build'
                    );
                await message.reply(embed);
                break;
            }
        ...
        `
                    ...
                    .setFooter(
                        'This documentation covers the current nightly build'
                    );
                await message.reply(embed);
                break;
            }
        ...
        `
            ...
            case '!32bitascom': {
                const embed = new Discord.MessageEmbed()
                    .setTitle(
                        'How to use 32bit COM objects in 64bit environments'
                    )
                    .setURL(
