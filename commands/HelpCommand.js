  ...
  async process(message) {
    ...
    switch (message.content) {
      ...
      case '!stars': {
        ...
        .setURL('https://nighttime-imaging.eu/docs/develop/site/tabs/imaging/')
        ...
        `)
        .setImage('https://nighttime-imaging.eu/wp-content/uploads/2020/06/stars.png')
        await message.reply(embed);
        break;
      }
      case '!help': {
        await message.reply('Available commands: !donate, !logs, !docs, !devdocs, !tracker, !issue, !repository, !nina, !nina.docs, !troubleshoot, !conform, !32bitascom, !stars');
        break;
      }
      default:
        break;
